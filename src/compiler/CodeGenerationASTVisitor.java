...
public class CodeGenerationASTVisitor extends BaseASTVisitor<String, VoidException> {
  ...
  private static List<List<String>> dispatchTables;
	...
	public String visitNode(EmptyNode n) {
		if (print) printNode(n);
		//-1 Ë diverso da qualsiasi object pointer
		return "push -1";
	}
	...
	public String visitNode(ClassCallNode n) {
		...
		return nlJoin(
			...
			"lfp", 			// recupero il valore dell'AR dove Ë dichiarata la classe
	...
	public String visitNode(CallNode n) {
		...
		return nlJoin(
			...
			getAR, 			// retrieve address of frame containing "id" declaration
							...
							// se Ë una chiamata a metodo  allora getAR = "lw" poichË
			...
			n.entry.type instanceof MethodTypeNode 
				...
				//se la chiamata non Ë a un metodo, resta invariato
				: nlJoin(
						"push "+n.entry.offset, 
						"add",
